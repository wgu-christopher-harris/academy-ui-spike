...
class SelectStyle extends BaseStyle {
    ...
    style = style;
    classes = classes;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: SelectStyle, deps: null, target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: SelectStyle });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: SelectStyle, decorators: [{
            type: Injectable
        }] });
/**
 *
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: SelectItem, decorators: [{
            type: Component,
            args: [{
...
class Select extends BaseInput {
    ...
    _offIconTemplate;
    filterOptions;
    _options = signal(null, ...(ngDevMode ? [{ debugName: "_options" }] : /* istanbul ignore next */ []));
    _placeholder = signal(undefined, ...(ngDevMode ? [{ debugName: "_placeholder" }] : /* istanbul ignore next */ []));
    value;
    hover;
    focused;
    overlayVisible;
    ...
    _filterValue = signal(null, ...(ngDevMode ? [{ debugName: "_filterValue" }] : /* istanbul ignore next */ []));
    searchValue;
    searchIndex;
    searchTimeout;
    previousSearchChar;
    ...
    labelId;
    listId;
    clicked = signal(false, ...(ngDevMode ? [{ debugName: "clicked" }] : /* istanbul ignore next */ []));
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: Select, decorators: [{
            type: Component,
            args: [{
                    selector: 'p-select',
                    standalone: true,
...
class SelectModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: SelectModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.13", ngImport: i0, type: SelectModule, imports: [Select, SharedModule], exports: [Select, SharedModule] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: SelectModule, imports: [Select, SharedModule, SharedModule] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: SelectModule, decorators: [{
            type: NgModule,
            args: [{

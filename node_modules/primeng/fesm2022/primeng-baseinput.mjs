...
class BaseInput extends BaseEditableHolder {
     ...
     * @group Props
     */
    inputSize = input(...(ngDevMode ? [undefined, { debugName: "inputSize" }] : /* istanbul ignore next */ []));
    /**
     * Specifies the value must match the pattern.
     * @defaultValue undefined
     * @group Props
     */
    pattern = input(...(ngDevMode ? [undefined, { debugName: "pattern" }] : /* istanbul ignore next */ []));
    /**

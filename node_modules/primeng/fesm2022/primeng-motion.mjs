...
class MotionStyle extends BaseStyle {
    ...
    style = style;
    classes = classes;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: MotionStyle, deps: null, target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: MotionStyle });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: MotionStyle, decorators: [{
            type: Injectable
        }] });
/**
 *
...
class Motion extends BaseComponent {
     ...
     * @group Props
     */
    safe = input(undefined, ...(ngDevMode ? [{ debugName: "safe" }] : /* istanbul ignore next */ []));
    /**
     ...
     * @group Props
     */
    enterFromClass = input(undefined, ...(ngDevMode ? [{ debugName: "enterFromClass" }] : /* istanbul ignore next */ []));
    /**
     * The enter to class of the motion.
     * @group Props
     */
    enterToClass = input(undefined, ...(ngDevMode ? [{ debugName: "enterToClass" }] : /* istanbul ignore next */ []));
    /**
     * The enter active class of the motion.
     * @group Props
     */
    enterActiveClass = input(undefined, ...(ngDevMode ? [{ debugName: "enterActiveClass" }] : /* istanbul ignore next */ []));
    /**
     * The leave from class of the motion.
     * @group Props
     */
    leaveFromClass = input(undefined, ...(ngDevMode ? [{ debugName: "leaveFromClass" }] : /* istanbul ignore next */ []));
    /**
     * The leave to class of the motion.
     * @group Props
     */
    leaveToClass = input(undefined, ...(ngDevMode ? [{ debugName: "leaveToClass" }] : /* istanbul ignore next */ []));
    /**
     * The leave active class of the motion.
     * @group Props
     */
    leaveActiveClass = input(undefined, ...(ngDevMode ? [{ debugName: "leaveActiveClass" }] : /* istanbul ignore next */ []));
    /******************** All Inputs ********************/
    /**
     * The motion options.
     * @group Props
...
class MotionModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: MotionModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.13", ngImport: i0, type: MotionModule, imports: [Motion, MotionDirective], exports: [Motion, MotionDirective] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: MotionModule, imports: [Motion] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: MotionModule, decorators: [{
            type: NgModule,
            args: [{

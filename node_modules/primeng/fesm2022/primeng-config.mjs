...
class ThemeProvider {
    ...
    csp = signal({ nonce: undefined }, ...(ngDevMode ? [{ debugName: "csp" }] : /* istanbul ignore next */ []));
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: ThemeProvider, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: ThemeProvider, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: ThemeProvider, decorators: [{
            type: Injectable,
...
class PrimeNG extends ThemeProvider {
    ...
    overlayOptions = {};
    csp = signal({ nonce: undefined }, ...(ngDevMode ? [{ debugName: "csp" }] : /* istanbul ignore next */ []));
    unstyled = signal(undefined, ...(ngDevMode ? [{ debugName: "unstyled" }] : /* istanbul ignore next */ []));
    pt = signal(undefined, ...(ngDevMode ? [{ debugName: "pt" }] : /* istanbul ignore next */ []));
    ptOptions = signal(undefined, ...(ngDevMode ? [{ debugName: "ptOptions" }] : /* istanbul ignore next */ []));
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: PrimeNG, deps: null, target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: PrimeNG, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: PrimeNG, decorators: [{
            type: Injectable,
            args: [{ providedIn: 'root' }]
        }] });

...
class ToastStyle extends BaseStyle {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: ToastStyle, deps: null, target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: ToastStyle });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: ToastStyle, decorators: [{
            type: Injectable
        }] });
/**
 *
...
class ToastItem extends BaseComponent {
    ...
    clearAll = input(null, ...(ngDevMode ? [{ debugName: "clearAll" }] : /* istanbul ignore next */ []));
    ...
    timeout;
    visible = signal(undefined, ...(ngDevMode ? [{ debugName: "visible" }] : /* istanbul ignore next */ []));
    isDestroyed = false;
    isClosing = false;
    constructor(zone) {
        super();
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: ToastItem, decorators: [{
            type: Component,
            args: [{
...
class Toast extends BaseComponent {
    ...
    id = uuid('pn_id_');
    templates;
    clearAllTrigger = signal(null, ...(ngDevMode ? [{ debugName: "clearAllTrigger" }] : /* istanbul ignore next */ []));
    constructor() {
        super();
    }
    onInit() {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: Toast, decorators: [{
            type: Component,
            args: [{
                    selector: 'p-toast',
                    standalone: true,
...
class ToastModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: ToastModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.13", ngImport: i0, type: ToastModule, imports: [Toast, SharedModule], exports: [Toast, SharedModule] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: ToastModule, imports: [Toast, SharedModule, SharedModule] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.13", ngImport: i0, type: ToastModule, decorators: [{
            type: NgModule,
            args: [{
